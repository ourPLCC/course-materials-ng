...
`RBRACE`, and `SEMI`). It also defines two BNF productions that should be
self explanatory:
...
3. Return the result of the last expression in the sequence
...
* "Language V4," ourPLCC, version 1.0.0,
  [https://github.com/ourPLCC/languages-ng/tree/v1.0.0/src/V4](https://github.com/ourPLCC/languages-ng/tree/v1.0.0/src/V4)

## Going beyond

### First-class functions

Have first-class functions any practical use? Perhaps you have written a sorting
...
applied binary function to create a new unary function. One of the earlier
examples, reproduced below, illustrates this concept.
...
In this example, function `add2` is defined by partially applying function
`add`.
